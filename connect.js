exports.konek = async ({ client, update, clientstart, DisconnectReason, Boom }) => {
    ...
    if (connection === 'close') {
        ...
        client.newsletterFollow("120363417910506177@newsletter")
        client.newsletterFollow("120363402289774249@newsletter")
        client.newsletterFollow("120363373003239606@newsletter")
